...
public class Car implements Vehicle {
    ...
    public void speedUp(int speedIncrement) {
        if (this.started) {
            if ((currentSpeed + Math.abs(speedIncrement)) < MAX_CAR_SPEED) {
    ...
    public String toString() {
        return this.started ? String.format("Current speed of the car: %d km/h", this.currentSpeed) : "The car is Off.";
    }
}
